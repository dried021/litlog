...
const UpdateUserForm = ({ userId }) => {
    ...
    const loadUser = async () => {
        try {
            const response = await axios.get(`/LitLog/api/setting/userinfo`, { withCredentials: true });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post(`/LitLog/api/setting/userinfo`, requestData);
