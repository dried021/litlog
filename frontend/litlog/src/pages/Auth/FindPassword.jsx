...
const FindPassword = () => {
  ...
  const handleSendCode = async () => {
    ...
    try {
      await axios.post('/LitLog/api/find-password/send-code', { id, name, email }, { withCredentials: true });
  ...
  const handleVerifyCode = async () => {
    ...
    try {
      await axios.post('/LitLog/api/find-password/verify-code', { id, code }, { withCredentials: true });
  ...
  const handleResetPassword = async () => {
    ...
    try {
      await axios.post('/LitLog/api/find-password/submit-new', { id, newPwd }, { withCredentials: true });
      openModal({
